<?php $__env->startSection('title', 'Yatı Düzenle'); ?>

<?php $__env->startSection('page_title', 'Yatı Düzenle'); ?>
<?php $__env->startSection('page_subtitle', 'Mevcut yat bilgilerini ve görsellerini güncelleyin.'); ?>

<?php $__env->startSection('content'); ?>
    <div class="panel-card">
        <div class="panel-card-header">
            <h3 class="panel-card-title"><i class="fas fa-edit"></i> Yat Düzenleme Formu</h3>
            <a href="<?php echo e(route('admin.yachts.index')); ?>" class="btn btn-outline">
                <i class="fas fa-arrow-left"></i> Geri Dön
            </a>
        </div>
        
        <form action="<?php echo e(route('admin.yachts.update', $yacht->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="lang-pane active" data-lang="tr">
                <div class="form-group">
                    ...
                    <input type="text" name="name[tr]" id="name_tr" class="form-control" value="<?php echo e(old('name.tr', $yacht->name['tr'] ?? '')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_tr">Kategori / Etiket (TR)</label>
                    <input type="text" name="tag[tr]" id="tag_tr" class="form-control" value="<?php echo e(old('tag.tr', $yacht->tag['tr'] ?? '')); ?>">
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="desc_tr">Kısa Açıklama (TR)</label>
                    <textarea name="desc[tr]" id="desc_tr" class="form-control" required><?php echo e(old('desc.tr', $yacht->desc['tr'] ?? '')); ?></textarea>
                </div>

                <div class="form-group">
                    <label class="form-label" for="long_desc_tr">Detaylı Açıklama (TR)</label>
                    <textarea name="long_desc[tr]" id="long_desc_tr" class="form-control"><?php echo e(old('long_desc.tr', $yacht->long_desc['tr'] ?? '')); ?></textarea>
                </div>
            </div>
            ...
            <div class="lang-pane" data-lang="en">
                <div class="form-group">
                    ...
                    <input type="text" name="name[en]" id="name_en" class="form-control" value="<?php echo e(old('name.en', $yacht->name['en'] ?? '')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_en">Category / Tag (EN)</label>
                    <input type="text" name="tag[en]" id="tag_en" class="form-control" value="<?php echo e(old('tag.en', $yacht->tag['en'] ?? '')); ?>">
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="desc_en">Short Description (EN)</label>
                    <textarea name="desc[en]" id="desc_en" class="form-control"><?php echo e(old('desc.en', $yacht->desc['en'] ?? '')); ?></textarea>
                </div>

                <div class="form-group">
                    <label class="form-label" for="long_desc_en">Detailed Description (EN)</label>
                    <textarea name="long_desc[en]" id="long_desc_en" class="form-control"><?php echo e(old('long_desc.en', $yacht->long_desc['en'] ?? '')); ?></textarea>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        ...
                        <div style="display: flex; gap: 1rem; align-items: center; margin-top: 0.5rem;">
                            <div>
                                ...
                                <div class="image-preview-box">
                                    <img src="<?php echo e(asset($yacht->img)); ?>" alt="">
                                </div>
                            </div>
                        ...
                        <div style="margin-top: 1rem;">
                            ...
                            <input type="text" name="img_url" id="img_url" class="form-control" value="<?php echo e(old('img_url', $yacht->img)); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        ...
                        <?php if($yacht->gallery && count($yacht->gallery) > 0): ?>
                            <div style="margin-top: 1.5rem;">
                                <label class="form-label">Mevcut Galeri Görselleri (Silmek istediklerinizi seçin)</label>
                                <div class="edit-gallery-grid">
                                    <?php $__currentLoopData = $yacht->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="edit-gallery-item">
                                            <img src="<?php echo e(str_starts_with($g, 'data:') ? $g : asset($g)); ?>" alt="">
                                            <div class="remove-check" title="Kaldır">
                                                <input type="checkbox" name="remove_gallery[]" value="<?php echo e($g); ?>">
                                            </div>
                                        </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                <div>
                    ...
                    <?php if($yacht->video_file): ?>
                        <span style="font-size: 0.8rem; color: var(--text-muted); display: block; margin-top: 0.25rem;">Mevcut: <?php echo e($yacht->video_file); ?></span>
                ...
                <div>
                    ...
                    <input type="text" name="video_url" id="video_url" class="form-control" placeholder="Örn: https://www.youtube.com/watch?v=..." value="<?php echo e(old('video_url', $yacht->video_url)); ?>">
                </div>
            </div>

            <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 2rem;">
                <input type="checkbox" name="show_video_on_cover" id="show_video_on_cover" value="1" <?php echo e(old('show_video_on_cover', $yacht->show_video_on_cover) ? 'checked' : ''); ?>>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <input type="text" name="slug_tr" id="slug_tr" class="form-control" placeholder="Örn: mukemmel-deniz-manzarali-otel (Boş bırakılırsa isimden otomatik üretilir)" value="<?php echo e(old('slug_tr', $yacht->slug_tr)); ?>">
                </div>
                <div>
                    <label class="form-label" for="slug_en">Özel URL Yapısı / Slug (EN)</label>
                    <input type="text" name="slug_en" id="slug_en" class="form-control" placeholder="e.g. perfect-sea-view-hotel" value="<?php echo e(old('slug_en', $yacht->slug_en)); ?>">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <input type="text" name="seo_title_tr" id="seo_title_tr" class="form-control" placeholder="Google'da görünecek başlık..." value="<?php echo e(old('seo_title_tr', $yacht->seo_title_tr)); ?>">
                </div>
                <div>
                    <label class="form-label" for="seo_title_en">SEO Başlığı (EN)</label>
                    <input type="text" name="seo_title_en" id="seo_title_en" class="form-control" placeholder="SEO Title for Google..." value="<?php echo e(old('seo_title_en', $yacht->seo_title_en)); ?>">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <textarea name="seo_description_tr" id="seo_description_tr" class="form-control" placeholder="Google'da görünecek açıklama metni..."><?php echo e(old('seo_description_tr', $yacht->seo_description_tr)); ?></textarea>
                </div>
                <div>
                    <label class="form-label" for="seo_description_en">SEO Açıklaması (EN)</label>
                    <textarea name="seo_description_en" id="seo_description_en" class="form-control" placeholder="SEO Description for Google..."><?php echo e(old('seo_description_en', $yacht->seo_description_en)); ?></textarea>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                <div>
                    ...
                    <?php if($yacht->og_image): ?>
                        <div style="margin-top:0.5rem;">
                            <img src="<?php echo e(asset($yacht->og_image)); ?>" style="height:50px; border-radius:4px; object-fit:cover;">
                        </div>
                    <?php endif; ?>
                ...
                <div style="display: flex; align-items: center; gap: 0.5rem; padding-top: 1.5rem;">
                    <input type="checkbox" name="seo_noindex" id="seo_noindex" value="1" <?php echo e(old('seo_noindex', $yacht->seo_noindex) ? 'checked' : ''); ?>>
            ...
            <div style="display: flex; gap: 1rem; justify-content: flex-end;">
                <a href="<?php echo e(route('admin.yachts.index')); ?>" class="btn btn-outline">İptal Et</a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmet\Desktop\dioreal web\resources\views\admin\yachts\edit.blade.php ENDPATH**/ ?>