...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/home.css')); ?>?v=2.5.0">
    <?php
...
<body>
    ...
    <section class="hero">
        <div class="hero-slider">
            <div class="hero-slide active"
                style="background-image:url('<?php echo e(asset(!empty($settings['hero_slide_1']) ? $settings['hero_slide_1'] : 'foto.img/hero_4k.jpg')); ?>')">
            </div>
            <div class="hero-slide"
                style="background-image:url('<?php echo e(asset(!empty($settings['hero_slide_2']) ? $settings['hero_slide_2'] : 'foto.img/hero_slide_2.jpg')); ?>')">
            </div>
            <div class="hero-slide"
                style="background-image:url('<?php echo e(asset(!empty($settings['hero_slide_3']) ? $settings['hero_slide_3'] : 'foto.img/hero_slide_3.jpg')); ?>')">
            </div>
        </div>
    ...
    <div class="marquee" style="position:relative;z-index:2;">
        <div class="marquee-track" style="pointer-events:auto;">
            <!-- SET A -->
            <div class="marquee-item"><a href="<?php echo e(url('/destinasyon/istanbul')); ?>" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_istanbul" style="color: inherit !important;">İstanbul</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="<?php echo e(url('/destinasyon/bodrum')); ?>" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_bodrum" style="color: inherit !important;">Bodrum</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="<?php echo e(url('/destinasyon/fethiye')); ?>" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_fethiye" style="color: inherit !important;">Fethiye</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="<?php echo e(url('/destinasyon/kapadokya')); ?>" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_kapadokya" style="color: inherit !important;">Kapadokya</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="<?php echo e(url('/destinasyon/cesme')); ?>" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_cesme" style="color: inherit !important;">Çeşme</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="<?php echo e(url('/destinasyon/kas')); ?>" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_kas" style="color: inherit !important;">Kaş</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="<?php echo e(url('/destinasyon/datca')); ?>" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_datca" style="color: inherit !important;">Datça</span></a> <span class="marquee-dot">◆</span></div>
            <!-- SET B (Clone) -->
            <div class="marquee-item" aria-hidden="true"><a href="<?php echo e(url('/destinasyon/istanbul')); ?>" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_istanbul" style="color: inherit !important;">İstanbul</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="<?php echo e(url('/destinasyon/bodrum')); ?>" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_bodrum" style="color: inherit !important;">Bodrum</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="<?php echo e(url('/destinasyon/fethiye')); ?>" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_fethiye" style="color: inherit !important;">Fethiye</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="<?php echo e(url('/destinasyon/kapadokya')); ?>" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_kapadokya" style="color: inherit !important;">Kapadokya</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="<?php echo e(url('/destinasyon/cesme')); ?>" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_cesme" style="color: inherit !important;">Çeşme</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="<?php echo e(url('/destinasyon/kas')); ?>" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_kas" style="color: inherit !important;">Kaş</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="<?php echo e(url('/destinasyon/datca')); ?>" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_datca" style="color: inherit !important;">Datça</span></a> <span class="marquee-dot">◆</span></div>
            <!-- SET C (Clone) -->
            <div class="marquee-item" aria-hidden="true"><a href="<?php echo e(url('/destinasyon/istanbul')); ?>" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_istanbul" style="color: inherit !important;">İstanbul</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="<?php echo e(url('/destinasyon/bodrum')); ?>" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_bodrum" style="color: inherit !important;">Bodrum</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="<?php echo e(url('/destinasyon/fethiye')); ?>" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_fethiye" style="color: inherit !important;">Fethiye</span></a> <span class="marquee-dot">◆</span></div>
    ...
    <section class="bt-about-section" id="hakkimizda" style="padding: 7rem 5rem; text-align: center; background: var(--white);">
        ...
        <div class="bt-about-grid" style="display: grid; gap: 2rem; text-align: left;">
            <!-- Trend Otel -->
            <a href="<?php echo e($settings['trend_otel_url'] ?? route('oteller')); ?>" class="bt-about-card" style="aspect-ratio: 3/4; position: relative; overflow: hidden; background: var(--near-black); cursor: pointer; transition: transform 0.4s; text-decoration: none; display: block;">
                <img src="<?php echo e(asset(!empty($settings['trend_otel_img']) ? $settings['trend_otel_img'] : 'foto.img/about_safari.webp')); ?>" alt="Trend Otel" loading="lazy" width="600" height="800" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.8s ease;">
            ...
            <!-- Trend Restoran -->
            <a href="<?php echo e($settings['trend_rest_url'] ?? route('restoran.detay', 'melengec-restaurant')); ?>" class="bt-about-card" style="aspect-ratio: 3/4; position: relative; overflow: hidden; background: var(--near-black); cursor: pointer; transition: transform 0.4s; text-decoration: none; display: block;">
                <img src="<?php echo e(asset(!empty($settings['trend_rest_img']) ? $settings['trend_rest_img'] : 'foto.img/rest_mikla.webp')); ?>" alt="Trend Restoran" loading="lazy" width="600" height="800" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.8s ease;">
                <div style="position: absolute; bottom: 0; left: 0; right: 0; padding: 2rem; background: linear-gradient(transparent, rgba(0,0,0,0.85)); color: white; pointer-events: none;">
                    <div style="font-size: 0.75rem; letter-spacing: 0.2em; text-transform: uppercase; margin-bottom: 0.5rem; color: rgba(255,255,255,0.8);">
            ...
            <!-- Trend Yat -->
            <a href="<?php echo e($settings['trend_yat_url'] ?? route('yat.detay', 'blue-voyage-yatch')); ?>" class="bt-about-card" style="aspect-ratio: 3/4; position: relative; overflow: hidden; background: var(--near-black); cursor: pointer; transition: transform 0.4s; text-decoration: none; display: block;">
                <img src="<?php echo e(asset(!empty($settings['trend_yat_img']) ? $settings['trend_yat_img'] : 'foto.img/about_yacht.webp')); ?>" alt="Trend Yat" loading="lazy" width="600" height="800" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.8s ease;">
                <div style="position: absolute; bottom: 0; left: 0; right: 0; padding: 2rem; background: linear-gradient(transparent, rgba(0,0,0,0.85)); color: white; pointer-events: none;">
                    <div style="font-size: 0.75rem; letter-spacing: 0.2em; text-transform: uppercase; margin-bottom: 0.5rem; color: rgba(255,255,255,0.8);">
            ...
            <!-- Trend Beach -->
            <a href="<?php echo e($settings['trend_beach_url'] ?? route('rehber.detay', 'bodrum')); ?>" class="bt-about-card" style="aspect-ratio: 3/4; position: relative; overflow: hidden; background: var(--near-black); cursor: pointer; transition: transform 0.4s; text-decoration: none; display: block;">
                <img src="<?php echo e(asset(!empty($settings['trend_beach_img']) ? $settings['trend_beach_img'] : 'foto.img/bodrum.webp')); ?>" alt="Trend Beach" loading="lazy" width="600" height="800" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.8s ease;">
                <div style="position: absolute; bottom: 0; left: 0; right: 0; padding: 2rem; background: linear-gradient(transparent, rgba(0,0,0,0.85)); color: white; pointer-events: none;">
                    <div style="font-size: 0.75rem; letter-spacing: 0.2em; text-transform: uppercase; margin-bottom: 0.5rem; color: rgba(255,255,255,0.8);">
            ...
            <div class="marquee-container">
                <div class="marquee-track">
                        ...
                        <?php $__currentLoopData = $destinations['turkiye']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('destinasyon.detay', $dest->slug_tr ?: ($dest->slug_en ?: $dest->id))); ?>" class="dest-card-h" style="display: block; text-decoration: none; color: inherit;">
                                <div class="dest-img-container">
                                    <div class="dest-img" style="background-image:url('<?php echo e(asset(!empty($dest->img) ? $dest->img : 'foto.img/amalfi.webp')); ?>'); position: absolute; inset: 0; background-size: cover; background-position: center; transition: transform 0.9s cubic-bezier(0.25, 0.46, 0.45, 0.94);"></div>
                                </div>
                    ...
                    <div class="marquee-content" aria-hidden="true">
                        <?php $__currentLoopData = $destinations['turkiye']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('destinasyon.detay', $dest->slug_tr ?: ($dest->slug_en ?: $dest->id))); ?>" class="dest-card-h" tabindex="-1" aria-hidden="true" style="display: block; text-decoration: none; color: inherit;">
                                <div class="dest-img-container">
                                    <div class="dest-img" style="background-image:url('<?php echo e(asset(!empty($dest->img) ? $dest->img : 'foto.img/amalfi.webp')); ?>'); position: absolute; inset: 0; background-size: cover; background-position: center; transition: transform 0.9s cubic-bezier(0.25, 0.46, 0.45, 0.94);"></div>
                                </div>
                                <div class="dest-info-ext">
        ...
        <div class="bt-logos-wrapper reveal" id="refsGrid" style="transition-delay: 0.2s;">
            <?php if(isset($settings['brands']) && is_array($settings['brands'])): ?>
                <?php $__currentLoopData = $settings['brands']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <img class="bt-logo-img" src="<?php echo e(asset($brand['img'])); ?>" alt="<?php echo e($brand['name']); ?>" title="<?php echo e($brand['name']); ?>" loading="lazy" width="140" height="60">
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
        </div>
    </section>
    ...
    <script src="<?php echo e(asset('js/home.js')); ?>?v=2.5.0"></script>
</body>
