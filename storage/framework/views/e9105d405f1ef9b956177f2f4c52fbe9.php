...
<body>
    <nav id="mainNav">
        ...
        <ul class="nav-links">
            ...
            <li><a href="<?php echo e(route('restoranlar')); ?>" class="active-page" data-i18n="nav_restaurants">Restoranlar</a></li>
    ...
    <section class="content-section alt" id="restoranlar">
        ...
        <div class="card-grid" id="restCardsGrid">
            <?php $__currentLoopData = $restoranlar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card reveal visible">
                    <div class="card-img" style="position: relative; overflow: hidden; background-image: none;">
                        <?php if($r->show_video_on_cover && (!empty($r->video_file) || !empty($r->video_url))): ?>
                            <?php if(!empty($r->video_file)): ?>
                                <video autoplay muted loop playsinline style="width: 100%; height: 100%; object-fit: cover; position: absolute; inset: 0;">
                                    <source src="<?php echo e(asset($r->video_file)); ?>" type="video/mp4">
                                </video>
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <div style="background-image:url('<?php echo e(asset($r->img)); ?>'); width: 100%; height: 100%; background-size: cover; background-position: center; position: absolute; inset: 0;"></div>
                        <?php endif; ?>
                    </div>
                    <div class="card-body">
                        <span class="card-tag lang-text-tr"><?php echo e($r->tag["tr"] ?? ""); ?></span>
                        <span class="card-tag lang-text-en"><?php echo e($r->tag["en"] ?? ""); ?></span>
                        
                        <h3 class="card-title lang-text-tr"><?php echo e($r->name["tr"] ?? ""); ?></h3>
                        <h3 class="card-title lang-text-en"><?php echo e($r->name["en"] ?? ""); ?></h3>
                        
                        <p class="card-desc lang-text-tr"><?php echo e($r->desc["tr"] ?? ""); ?></p>
                        <p class="card-desc lang-text-en"><?php echo e($r->desc["en"] ?? ""); ?></p>
                        
                        <a href="<?php echo e(route('restoran.detay', $r->slug_tr ?? $r->slug_en ?? $r->id)); ?>" class="btn btn-primary" style="margin-top:1rem; padding: 0.5rem 1rem;">
...
<?php /**PATH C:\Users\ahmet\Desktop\dioreal web\resources\views\restoranlar.blade.php ENDPATH**/ ?>