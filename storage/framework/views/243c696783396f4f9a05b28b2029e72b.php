<?php $__env->startSection('title', 'Yeni Yat Ekle'); ?>

<?php $__env->startSection('page_title', 'Yeni Yat Ekle'); ?>
<?php $__env->startSection('page_subtitle', 'Koleksiyona eklenecek yeni lüks yatın detaylarını girin.'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="panel-card">
        ...
        <form action="<?php echo e(route('admin.yachts.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="lang-pane active" data-lang="tr">
                <div class="form-group">
                    ...
                    <input type="text" name="name[tr]" id="name_tr" class="form-control" placeholder="Örn: Custom Line 120" value="<?php echo e(old('name.tr')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_tr">Kategori / Etiket (TR)</label>
                    <input type="text" name="tag[tr]" id="tag_tr" class="form-control" placeholder="Örn: Motor Yat & 38 Metre" value="<?php echo e(old('tag.tr')); ?>">
                </div>
            ...
            <div class="lang-pane" data-lang="en">
                <div class="form-group">
                    ...
                    <input type="text" name="name[en]" id="name_en" class="form-control" placeholder="e.g. Custom Line 120" value="<?php echo e(old('name.en')); ?>">
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_en">Category / Tag (EN)</label>
                    <input type="text" name="tag[en]" id="tag_en" class="form-control" placeholder="e.g. Motor Yacht & 38 Meters" value="<?php echo e(old('tag.en')); ?>">
                </div>
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        ...
                        <div style="margin-top: 1rem;">
                            ...
                            <input type="text" name="img_url" id="img_url" class="form-control" placeholder="Örn: foto.img/yat_custom.jpg" value="<?php echo e(old('img_url')); ?>">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmet\Desktop\dioreal web\resources\views\admin\yachts\create.blade.php ENDPATH**/ ?>