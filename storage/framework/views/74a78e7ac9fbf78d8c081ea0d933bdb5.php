...
<body>
    ...
    <nav id="mainNav">
        ...
        <ul class="nav-links">
            ...
            <li><a href="<?php echo e(url('/oteller')); ?>" class="active-page" data-i18n="nav_hotels">Oteller</a></li>
    ...
    ?>
    <div class="page-hero" style="<?php if(!$showVideoCover): ?> background-image: url('<?php echo e($otelImgUrl); ?>'); <?php endif; ?>">
        <?php if($showVideoCover): ?>
            <div class="hero-video-container" style="position: absolute; inset: 0; width: 100%; height: 100%; overflow: hidden; z-index: 0;">
                <?php if(!empty($otel->video_file)): ?>
                    <video src="<?php echo e(asset($otel->video_file)); ?>" autoplay loop muted playsinline style="width: 100%; height: 100%; object-fit: cover;"></video>
        ...
        <div class="page-hero-content" style="position: relative; z-index: 2;">
            <span class="page-eyebrow lang-text-tr"><?php echo e($otel->tag['tr'] ?? ''); ?></span>
            <span class="page-eyebrow lang-text-en"><?php echo e($otel->tag['en'] ?? ''); ?></span>
            <h1 class="page-title lang-text-tr"><?php echo e($otel->name['tr'] ?? ''); ?></h1>
            <h1 class="page-title lang-text-en"><?php echo e($otel->name['en'] ?? ''); ?></h1>
        </div>
    </div>
        ...
        <div class="detail-grid">
            ...
            <div class="detail-story reveal">
                ...
                <div class="lang-text-tr">
                    <?php echo nl2br($otel->long_desc['tr'] ?? ($otel->desc['tr'] ?? '')); ?>

                </div>
                <div class="lang-text-en">
                    <?php echo nl2br($otel->long_desc['en'] ?? ($otel->desc['en'] ?? '')); ?>
            ...
            <div class="detail-sidebar-card reveal" style="transition-delay: 0.2s">
                ...
                <div class="sidebar-info-item">
                    ...
                    <div>
                        ...
                        <div class="sidebar-info-value lang-text-tr"><?php echo e($otel->location['tr'] ?? ($otel->destination->name['tr'] ?? ($otel->tag['tr'] ?? ''))); ?></div>
                        <div class="sidebar-info-value lang-text-en"><?php echo e($otel->location['en'] ?? ($otel->destination->name['en'] ?? ($otel->tag['en'] ?? ''))); ?></div>
                    </div>
                </div>
                ...
                <a href="https://wa.me/<?php echo e(format_whatsapp($settings['whatsapp'] ?? '')); ?>?text=Merhaba,%20<?php echo e(urlencode($otel->name['tr'] ?? $otel->name['en'] ?? 'Otel')); ?>%20hakkında%20detaylı%20bilgi%20ve%20rezervasyon%20talebinde%20bulunmak%20istiyorum." 
                   target="_blank" 
                   class="btn-booking">
    ...
    <?php if(!empty($otel->video_file) || !empty($otel->video_url)): ?>
        <section class="video-section reveal" style="max-width: 1200px; margin: 4rem auto; padding: 0 2rem;">
            ...
            <div class="video-container" style="position: relative; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 50px rgba(0,0,0,0.15); background: #000; aspect-ratio: 16/9; max-width: 900px; margin: 0 auto;">
                <?php if(!empty($otel->video_file)): ?>
                    <video src="<?php echo e(asset($otel->video_file)); ?>" controls style="width: 100%; height: 100%; object-fit: cover;"></video>
                <?php elseif(!empty($otel->video_url)): ?>
                    <?php
                        $embedUrl = $otel->video_url;
                        if (preg_match('/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/ ]{11})/', $otel->video_url, $matches)) {
    ...
    <section class="gallery-section reveal">
        ...
        <div class="gallery-grid">
            <?php if(!empty($otel->gallery) && is_array($otel->gallery)): ?>
                <?php $__currentLoopData = $otel->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="gallery-img-wrapper">
                        <img src="<?php echo e(str_starts_with($g, 'data:') || str_starts_with($g, 'http') ? $g : asset($g)); ?>" alt="Otel Görseli">
                    </div>
...
<?php /**PATH C:\Users\ahmet\Desktop\dioreal web\resources\views\otel-detay.blade.php ENDPATH**/ ?>