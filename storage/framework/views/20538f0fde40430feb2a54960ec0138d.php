<?php $__env->startSection('title', 'Journal Yazısını Düzenle'); ?>

<?php $__env->startSection('page_title', 'Journal Yazısını Düzenle'); ?>
<?php $__env->startSection('page_subtitle', 'Mevcut journal yazısını güncelleyin.'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="panel-card">
        ...
        <form action="<?php echo e(route('admin.journals.update', $journal->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="lang-pane active" data-lang="tr">
                <div class="form-group">
                    ...
                    <input type="text" name="title[tr]" id="title_tr" class="form-control" value="<?php echo e(old('title.tr', $journal->title['tr'] ?? '')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_tr">Kategori / Etiket (TR)</label>
                    <input type="text" name="tag[tr]" id="tag_tr" class="form-control" value="<?php echo e(old('tag.tr', $journal->tag['tr'] ?? '')); ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc[tr]" id="desc_tr" class="form-control" required style="min-height: 120px;"><?php echo e(old('desc.tr', $journal->desc['tr'] ?? '')); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content[tr]" id="content_tr" class="form-control" style="min-height: 350px;"><?php echo e(old('content.tr', $journal->content['tr'] ?? '')); ?></textarea>
                </div>
            </div>
            ...
            <div class="lang-pane" data-lang="en">
                <div class="form-group">
                    ...
                    <input type="text" name="title[en]" id="title_en" class="form-control" value="<?php echo e(old('title.en', $journal->title['en'] ?? '')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_en">Category / Tag (EN)</label>
                    <input type="text" name="tag[en]" id="tag_en" class="form-control" value="<?php echo e(old('tag.en', $journal->tag['en'] ?? '')); ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc[en]" id="desc_en" class="form-control" style="min-height: 120px;"><?php echo e(old('desc.en', $journal->desc['en'] ?? '')); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content[en]" id="content_en" class="form-control" style="min-height: 350px;"><?php echo e(old('content.en', $journal->content['en'] ?? '')); ?></textarea>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                ...
                <div>
                    <div class="form-group">
                        ...
                        <select name="destination_id" id="destination_id" class="form-control">
                            ...
                            <?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($dest->id); ?>" <?php echo e(old('destination_id', $journal->destination_id) == $dest->id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="date" id="date" class="form-control" value="<?php echo e(old('date', $journal->date)); ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="read_time" id="read_time" class="form-control" value="<?php echo e(old('read_time', $journal->read_time)); ?>" min="1" max="120">
                    </div>

                    <div class="form-group">
                        <label class="form-label" style="display:flex; align-items:center; gap:0.75rem; cursor:pointer;">
                            <input type="hidden" name="is_featured" value="0">
                            <input type="checkbox" name="is_featured" value="1" <?php echo e(old('is_featured', $journal->is_featured) ? 'checked' : ''); ?>
                    ...
                    <div class="form-group" style="margin-top: 1.5rem; border-top: 1px solid var(--border-color); padding-top: 1.5rem;">
                        ...
                        <?php if($journal->video_file): ?>
                            <span style="font-size: 0.8rem; color: var(--text-muted); display: block; margin-top: 0.25rem;">Mevcut: <?php echo e($journal->video_file); ?></span>
                        ...
                        <input type="text" name="video_url" id="video_url" class="form-control" placeholder="Örn: https://www.youtube.com/watch?v=..." value="<?php echo e(old('video_url', $journal->video_url)); ?>" style="margin-bottom: 1rem;">
                        
                        <div style="display: flex; align-items: center; gap: 0.5rem; margin-top: 1rem;">
                            <input type="checkbox" name="show_video_on_cover" id="show_video_on_cover" value="1" <?php echo e(old('show_video_on_cover', $journal->show_video_on_cover) ? 'checked' : ''); ?>>
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        ...
                        <div style="display: flex; gap: 1rem; align-items: center; margin-top: 0.5rem;">
                            <div>
                                ...
                                <div style="width: 120px; height: 80px; overflow:hidden; border-radius:4px; border:1px solid var(--border-color);">
                                    <img src="<?php echo e(asset($journal->img)); ?>" alt="" style="width:100%; height:100%; object-fit:cover;">
                                </div>
                            </div>
                        ...
                        <div style="margin-top: 1rem;">
                            ...
                            <input type="text" name="img_url" id="img_url" class="form-control" value="<?php echo e(old('img_url', $journal->img)); ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <input type="text" name="slug_tr" id="slug_tr" class="form-control" placeholder="Örn: mukemmel-deniz-manzarali-otel (Boş bırakılırsa isimden otomatik üretilir)" value="<?php echo e(old('slug_tr', $journal->slug_tr)); ?>">
                </div>
                <div>
                    <label class="form-label" for="slug_en">Özel URL Yapısı / Slug (EN)</label>
                    <input type="text" name="slug_en" id="slug_en" class="form-control" placeholder="e.g. perfect-sea-view-hotel" value="<?php echo e(old('slug_en', $journal->slug_en)); ?>">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <input type="text" name="seo_title_tr" id="seo_title_tr" class="form-control" placeholder="Google'da görünecek başlık..." value="<?php echo e(old('seo_title_tr', $journal->seo_title_tr)); ?>">
                </div>
                <div>
                    <label class="form-label" for="seo_title_en">SEO Başlığı (EN)</label>
                    <input type="text" name="seo_title_en" id="seo_title_en" class="form-control" placeholder="SEO Title for Google..." value="<?php echo e(old('seo_title_en', $journal->seo_title_en)); ?>">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <textarea name="seo_description_tr" id="seo_description_tr" class="form-control" placeholder="Google'da görünecek açıklama metni..."><?php echo e(old('seo_description_tr', $journal->seo_description_tr)); ?></textarea>
                </div>
                <div>
                    <label class="form-label" for="seo_description_en">SEO Açıklaması (EN)</label>
                    <textarea name="seo_description_en" id="seo_description_en" class="form-control" placeholder="SEO Description for Google..."><?php echo e(old('seo_description_en', $journal->seo_description_en)); ?></textarea>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                <div>
                    ...
                    <?php if($journal->og_image): ?>
                        <div style="margin-top:0.5rem;">
                            <img src="<?php echo e(asset($journal->og_image)); ?>" style="height:50px; border-radius:4px; object-fit:cover;">
                        </div>
                    <?php endif; ?>
                ...
                <div style="display: flex; align-items: center; gap: 0.5rem; padding-top: 1.5rem;">
                    <input type="checkbox" name="seo_noindex" id="seo_noindex" value="1" <?php echo e(old('seo_noindex', $journal->seo_noindex) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmet\Desktop\dioreal web\resources\views\admin\journals\edit.blade.php ENDPATH**/ ?>