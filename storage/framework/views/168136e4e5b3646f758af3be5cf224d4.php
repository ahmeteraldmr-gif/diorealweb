<?php $__env->startSection('title', 'Yeni Etkinlik Ekle'); ?>

<?php $__env->startSection('page_title', 'Yeni Etkinlik Ekle'); ?>
<?php $__env->startSection('page_subtitle', 'Koleksiyona eklenecek yeni etkinliğin detaylarını girin.'); ?>
        ...
        <form action="<?php echo e(route('admin.events.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="lang-pane active" data-lang="tr">
                <div class="form-group">
                    ...
                    <input type="text" name="title[tr]" id="title_tr" class="form-control" placeholder="Örn: Bodrum Caz Festivali" value="<?php echo e(old('title.tr')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_tr">Kategori / Etiket (TR)</label>
                    <input type="text" name="tag[tr]" id="tag_tr" class="form-control" placeholder="Örn: Müzik & Festival" value="<?php echo e(old('tag.tr')); ?>">
                </div>

                <div class="form-group">
                    <label class="form-label" for="month_tr">Ay Bilgisi (TR)</label>
                    <input type="text" name="month[tr]" id="month_tr" class="form-control" placeholder="Örn: HAZİRAN" value="<?php echo e(old('month.tr')); ?>" required>
                </div>

                <div class="form-group">
                    <label class="form-label" for="loc_tr">Mekan / Lokasyon (TR)</label>
                    <input type="text" name="loc[tr]" id="loc_tr" class="form-control" placeholder="Örn: Antik Tiyatro, Bodrum" value="<?php echo e(old('loc.tr')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="desc_tr">Açıklama (TR)</label>
                    <textarea name="desc[tr]" id="desc_tr" class="form-control" placeholder="Etkinlik açıklaması..." required style="min-height: 120px;"><?php echo e(old('desc.tr')); ?></textarea>
                </div>

                <div class="form-group">
                    <label class="form-label" for="long_desc_tr">Detaylı Açıklama (TR)</label>
                    <textarea name="long_desc[tr]" id="long_desc_tr" class="form-control" placeholder="Etkinlik detaylı açıklaması..." style="min-height: 200px;"><?php echo e(old('long_desc.tr')); ?></textarea>
                </div>
            </div>
            ...
            <div class="lang-pane" data-lang="en">
                <div class="form-group">
                    ...
                    <input type="text" name="title[en]" id="title_en" class="form-control" placeholder="e.g. Bodrum Jazz Festival" value="<?php echo e(old('title.en')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_en">Category / Tag (EN)</label>
                    <input type="text" name="tag[en]" id="tag_en" class="form-control" placeholder="e.g. Music & Festival" value="<?php echo e(old('tag.en')); ?>">
                </div>

                <div class="form-group">
                    <label class="form-label" for="month_en">Month Info (EN)</label>
                    <input type="text" name="month[en]" id="month_en" class="form-control" placeholder="e.g. JUNE" value="<?php echo e(old('month.en')); ?>" required>
                </div>

                <div class="form-group">
                    <label class="form-label" for="loc_en">Venue / Location (EN)</label>
                    <input type="text" name="loc[en]" id="loc_en" class="form-control" placeholder="e.g. Antique Theatre, Bodrum" value="<?php echo e(old('loc.en')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="desc_en">Description (EN)</label>
                    <textarea name="desc[en]" id="desc_en" class="form-control" placeholder="Event description..." required style="min-height: 120px;"><?php echo e(old('desc.en')); ?></textarea>
                </div>

                <div class="form-group">
                    <label class="form-label" for="long_desc_en">Detailed Description (EN)</label>
                    <textarea name="long_desc[en]" id="long_desc_en" class="form-control" placeholder="Event detailed description..." style="min-height: 200px;"><?php echo e(old('long_desc.en')); ?></textarea>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                ...
                <div>
                    <div class="form-group" style="margin-bottom: 1.5rem;">
                        ...
                        <input type="text" name="day" id="day" class="form-control" placeholder="Örn: 15 veya 15-18" value="<?php echo e(old('day')); ?>" required>
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        ...
                        <div style="margin-top: 1rem;">
                            ...
                            <input type="text" name="img_url" id="img_url" class="form-control" placeholder="Örn: foto.img/bodrum_event.jpg" value="<?php echo e(old('img_url')); ?>">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmet\Desktop\dioreal web\resources\views\admin\events\create.blade.php ENDPATH**/ ?>