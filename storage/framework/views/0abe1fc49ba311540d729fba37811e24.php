<?php $__env->startSection('title', 'Restoranı Düzenle'); ?>

<?php $__env->startSection('page_title', 'Restoranı Düzenle'); ?>
<?php $__env->startSection('page_subtitle', 'Mevcut restoran bilgilerini ve görsellerini güncelleyin.'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="panel-card">
        ...
        <form action="<?php echo e(route('admin.restaurants.update', $restaurant->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="lang-pane active" data-lang="tr">
                <div class="form-group">
                    ...
                    <input type="text" name="name[tr]" id="name_tr" class="form-control" value="<?php echo e(old('name.tr', $restaurant->name['tr'] ?? '')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_tr">Kategori / Etiket (TR)</label>
                    <input type="text" name="tag[tr]" id="tag_tr" class="form-control" value="<?php echo e(old('tag.tr', $restaurant->tag['tr'] ?? '')); ?>" list="category_list_tr">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location[tr]" id="location_tr" class="form-control" placeholder="Örn: Yalıkavak, Bodrum" value="<?php echo e(old('location.tr', $restaurant->location['tr'] ?? '')); ?>">
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="desc_tr">Kısa Açıklama (TR)</label>
                    <textarea name="desc[tr]" id="desc_tr" class="form-control" required><?php echo e(old('desc.tr', $restaurant->desc['tr'] ?? '')); ?></textarea>
                </div>

                <div class="form-group">
                    <label class="form-label" for="long_desc_tr">Detaylı Açıklama (TR)</label>
                    <textarea name="long_desc[tr]" id="long_desc_tr" class="form-control"><?php echo e(old('long_desc.tr', $restaurant->long_desc['tr'] ?? '')); ?></textarea>
                </div>
            </div>
            ...
            <div class="lang-pane" data-lang="en">
                <div class="form-group">
                    ...
                    <input type="text" name="name[en]" id="name_en" class="form-control" value="<?php echo e(old('name.en', $restaurant->name['en'] ?? '')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_en">Category / Tag (EN)</label>
                    <input type="text" name="tag[en]" id="tag_en" class="form-control" value="<?php echo e(old('tag.en', $restaurant->tag['en'] ?? '')); ?>" list="category_list_en">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location[en]" id="location_en" class="form-control" placeholder="e.g. Yalikavak, Bodrum" value="<?php echo e(old('location.en', $restaurant->location['en'] ?? '')); ?>">
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="desc_en">Short Description (EN)</label>
                    <textarea name="desc[en]" id="desc_en" class="form-control"><?php echo e(old('desc.en', $restaurant->desc['en'] ?? '')); ?></textarea>
                </div>

                <div class="form-group">
                    <label class="form-label" for="long_desc_en">Detailed Description (EN)</label>
                    <textarea name="long_desc[en]" id="long_desc_en" class="form-control"><?php echo e(old('long_desc.en', $restaurant->long_desc['en'] ?? '')); ?></textarea>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        ...
                        <div style="display: flex; gap: 1rem; align-items: center; margin-top: 0.5rem;">
                            <div>
                                ...
                                <div class="image-preview-box">
                                    <img src="<?php echo e(asset($restaurant->img)); ?>" alt="">
                                </div>
                            </div>
                        ...
                        <div style="margin-top: 1rem;">
                            ...
                            <input type="text" name="img_url" id="img_url" class="form-control" value="<?php echo e(old('img_url', $restaurant->img)); ?>">
                        </div>
                    </div>
                </div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        ...
                        <div style="margin-top: 1.5rem;">
                            ...
                            <div id="gallery-sortable-container">
                                <?php if($restaurant->gallery && count($restaurant->gallery) > 0): ?>
                                    <?php $__currentLoopData = $restaurant->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="gallery-item <?php echo e($g == $restaurant->img ? 'is-cover' : ''); ?>" data-path="<?php echo e($g); ?>">
                                            <img src="<?php echo e(str_starts_with($g, 'data:') ? $g : asset($g)); ?>" alt="">
                                            <span class="cover-badge <?php echo e($g == $restaurant->img ? '' : 'd-none'); ?>">KAPAK</span>
                            ...
                            <input type="hidden" name="cover_image" id="cover_image" value="<?php echo e($restaurant->img); ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                <div>
                    ...
                    <input type="text" name="destination_name" id="destination_name" class="form-control" placeholder="Örn: Bodrum (Boş bırakabilir veya yeni yazabilirsiniz)" value="<?php echo e(old('destination_name', $restaurant->destination ? ($restaurant->destination->name['tr'] ?? '') : '')); ?>" list="destination_list">
                ...
                <div>
                    ...
                    <input type="number" name="order" id="order" class="form-control" placeholder="0" value="<?php echo e(old('order', $restaurant->order)); ?>">
                </div>
                <div style="display: flex; flex-direction: column; gap: 0.75rem; margin-top: 1.5rem;">
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                        <input type="checkbox" name="is_archived" id="is_archived" value="1" <?php echo e(old('is_archived', $restaurant->is_archived) ? 'checked' : ''); ?>>
                        <label class="form-label" for="is_archived" style="margin-bottom:0; cursor:pointer;">Bu Restoranı Arşivle (Yayından Kaldır)</label>
                    </div>
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                        <input type="checkbox" name="show_video_on_cover" id="show_video_on_cover" value="1" <?php echo e(old('show_video_on_cover', $restaurant->show_video_on_cover) ? 'checked' : ''); ?>>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                <div>
                    ...
                    <?php if($restaurant->video_file): ?>
                        <span style="font-size: 0.8rem; color: var(--text-muted); display: block; margin-top: 0.25rem;">Mevcut: <?php echo e($restaurant->video_file); ?></span>
                ...
                <div>
                    ...
                    <input type="text" name="video_url" id="video_url" class="form-control" placeholder="Örn: https://www.youtube.com/watch?v=..." value="<?php echo e(old('video_url', $restaurant->video_url)); ?>">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <input type="text" name="slug_tr" id="slug_tr" class="form-control" placeholder="Örn: mukemmel-deniz-manzarali-otel (Boş bırakılırsa isimden otomatik üretilir)" value="<?php echo e(old('slug_tr', $restaurant->slug_tr)); ?>">
                </div>
                <div>
                    <label class="form-label" for="slug_en">Özel URL Yapısı / Slug (EN)</label>
                    <input type="text" name="slug_en" id="slug_en" class="form-control" placeholder="e.g. perfect-sea-view-hotel" value="<?php echo e(old('slug_en', $restaurant->slug_en)); ?>">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <input type="text" name="seo_title_tr" id="seo_title_tr" class="form-control" placeholder="Google'da görünecek başlık..." value="<?php echo e(old('seo_title_tr', $restaurant->seo_title_tr)); ?>">
                </div>
                <div>
                    <label class="form-label" for="seo_title_en">SEO Başlığı (EN)</label>
                    <input type="text" name="seo_title_en" id="seo_title_en" class="form-control" placeholder="SEO Title for Google..." value="<?php echo e(old('seo_title_en', $restaurant->seo_title_en)); ?>">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <textarea name="seo_description_tr" id="seo_description_tr" class="form-control" placeholder="Google'da görünecek açıklama metni..."><?php echo e(old('seo_description_tr', $restaurant->seo_description_tr)); ?></textarea>
                </div>
                <div>
                    <label class="form-label" for="seo_description_en">SEO Açıklaması (EN)</label>
                    <textarea name="seo_description_en" id="seo_description_en" class="form-control" placeholder="SEO Description for Google..."><?php echo e(old('seo_description_en', $restaurant->seo_description_en)); ?></textarea>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                <div>
                    ...
                    <?php if($restaurant->og_image): ?>
                        <div style="margin-top:0.5rem;">
                            <img src="<?php echo e(asset($restaurant->og_image)); ?>" style="height:50px; border-radius:4px; object-fit:cover;">
                        </div>
                    <?php endif; ?>
                ...
                <div style="display: flex; align-items: center; gap: 0.5rem; padding-top: 1.5rem;">
                    <input type="checkbox" name="seo_noindex" id="seo_noindex" value="1" <?php echo e(old('seo_noindex', $restaurant->seo_noindex) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmet\Desktop\dioreal web\resources\views\admin\restaurants\edit.blade.php ENDPATH**/ ?>