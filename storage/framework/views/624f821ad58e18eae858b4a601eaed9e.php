<?php $__env->startSection('title', 'Genel Ayarlar'); ?>

<?php $__env->startSection('page_title', 'Genel Ayarlar'); ?>
<?php $__env->startSection('page_subtitle', 'Sitenin iletişim bilgileri, sosyal ağ entegrasyonları, hero başlıkları, anasayfa/hakkımızda içerikleri ve marka referanslarının yönetimi.'); ?>
...
<div style="display: grid; grid-template-columns: 1fr; gap: 2.5rem;">
    ...
    <div class="panel-card">
        ...
        <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" enctype="multipart/form-data" style="padding: 1.5rem;">
            <?php echo csrf_field(); ?>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2rem; margin-top: 1.5rem;">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="contact_email" id="contact_email" value="<?php echo e($settings['contact_email'] ?? ''); ?>" placeholder="info@diorealdijital.com">
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="contact_phone">Telefon Numarası</label>
                            <input type="text" class="form-control" name="contact_phone" id="contact_phone" value="<?php echo e($settings['contact_phone'] ?? ''); ?>" placeholder="+90 212 555 0100">
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="contact_address_tr">Adres (TR)</label>
                            <input type="text" class="form-control" name="contact_address_tr" id="contact_address_tr" value="<?php echo e($settings['contact_address_tr'] ?? ''); ?>" placeholder="İstanbul, Türkiye">
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="contact_address_en">Adres (EN)</label>
                            <input type="text" class="form-control" name="contact_address_en" id="contact_address_en" value="<?php echo e($settings['contact_address_en'] ?? ''); ?>" placeholder="Istanbul, Turkey">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control" name="instagram" id="instagram" value="<?php echo e($settings['instagram'] ?? ''); ?>" placeholder="https://instagram.com/kullanici">
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="linkedin">LinkedIn Profili</label>
                            <input type="url" class="form-control" name="linkedin" id="linkedin" value="<?php echo e($settings['linkedin'] ?? ''); ?>" placeholder="https://linkedin.com/company/sirket">
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="whatsapp">WhatsApp Buton Numarası</label>
                            <input type="text" class="form-control" name="whatsapp" id="whatsapp" value="<?php echo e($settings['whatsapp'] ?? ''); ?>" placeholder="905320000000">
            ...
            <div id="tab-homepage" class="setting-tab-pane">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <div class="img-preview-container">
                            <img class="img-preview" src="<?php echo e(asset($settings['hero_slide_1'] ?? 'foto.img/hero_4k.jpg')); ?>" alt="Slide 1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="img-preview-container">
                            <img class="img-preview" src="<?php echo e(asset($settings['hero_slide_2'] ?? 'foto.img/hero_slide_2.jpg')); ?>" alt="Slide 2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="img-preview-container">
                            <img class="img-preview" src="<?php echo e(asset($settings['hero_slide_3'] ?? 'foto.img/hero_slide_3.jpg')); ?>" alt="Slide 3">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="man_eyebrow_tr" id="man_eyebrow_tr" value="<?php echo e($settings['man_eyebrow_tr'] ?? 'BU AYIN SEÇKİNLERİ'); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="man_eyebrow_en">Üst Başlık (EN)</label>
                        <input type="text" class="form-control" name="man_eyebrow_en" id="man_eyebrow_en" value="<?php echo e($settings['man_eyebrow_en'] ?? "THIS MONTH'S SELECTION"); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label" for="man_p1_tr">Açıklama Metni (TR)</label>
                    <textarea class="form-control" name="man_p1_tr" id="man_p1_tr" rows="3"><?php echo e($settings['man_p1_tr'] ?? 'Sizler için özenle seçtiğimiz bu ayın en trend otel, restoran, yat ve plaj lokasyonlarının ardındaki eşsiz hikayeleri keşfedin.'); ?></textarea>
                </div>
                <div class="form-group">
                    <label class="form-label" for="man_p1_en">Açıklama Metni (EN)</label>
                    <textarea class="form-control" name="man_p1_en" id="man_p1_en" rows="3"><?php echo e($settings['man_p1_en'] ?? "Explore the unique stories behind this month's trending hotels, restaurants, yachts, and beach spots carefully selected for you."); ?></textarea>
                </div>
                            ...
                            <div>
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="trend_otel_title_tr" value="<?php echo e($settings['trend_otel_title_tr'] ?? 'Kassandra Villa'); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Kart Başlığı (EN)</label>
                                        <input type="text" class="form-control" name="trend_otel_title_en" value="<?php echo e($settings['trend_otel_title_en'] ?? 'Kassandra Villa'); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Alt Açıklama (TR)</label>
                                    <input type="text" class="form-control" name="trend_otel_desc_tr" value="<?php echo e($settings['trend_otel_desc_tr'] ?? 'Ege\'nin gizli kalmış koylarında uyanmanın eşsiz hissi.'); ?>">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Alt Açıklama (EN)</label>
                                    <input type="text" class="form-control" name="trend_otel_desc_en" value="<?php echo e($settings['trend_otel_desc_en'] ?? 'The unique feeling of waking up in the hidden bays of the Aegean.'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Görsel</label>
                                <div class="img-preview-container" style="height: calc(100% - 25px); margin-top: 0;">
                                    <img class="img-preview" src="<?php echo e(asset($settings['trend_otel_img'] ?? 'foto.img/about_safari.jpg')); ?>" alt="Trend Otel">
                        ...
                        <div style="display: grid; grid-template-columns: 1.3fr 1fr; gap: 1.5rem;">
                            <div>
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                    <div class="form-group">
                                        <label class="form-label">Kart Başlığı (TR)</label>
                                        <input type="text" class="form-control" name="trend_rest_title_tr" value="<?php echo e($settings['trend_rest_title_tr'] ?? 'Melengeç'); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Kart Başlığı (EN)</label>
                                        <input type="text" class="form-control" name="trend_rest_title_en" value="<?php echo e($settings['trend_rest_title_en'] ?? 'Melengeç'); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Alt Açıklama (TR)</label>
                                    <input type="text" class="form-control" name="trend_rest_desc_tr" value="<?php echo e($settings['trend_rest_desc_tr'] ?? 'Taze deniz ürünleri ile unutulmaz bir gastronomi yolculuğu.'); ?>">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Alt Açıklama (EN)</label>
                                    <input type="text" class="form-control" name="trend_rest_desc_en" value="<?php echo e($settings['trend_rest_desc_en'] ?? 'An unforgettable gastronomic journey with fresh seafood.'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Görsel</label>
                                <div class="img-preview-container" style="height: calc(100% - 25px); margin-top: 0;">
                                    <img class="img-preview" src="<?php echo e(asset($settings['trend_rest_img'] ?? 'foto.img/rest_mikla.jpg')); ?>" alt="Trend Restoran">
                        ...
                        <div style="display: grid; grid-template-columns: 1.3fr 1fr; gap: 1.5rem;">
                            <div>
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                    <div class="form-group">
                                        <label class="form-label">Kart Başlığı (TR)</label>
                                        <input type="text" class="form-control" name="trend_yat_title_tr" value="<?php echo e($settings['trend_yat_title_tr'] ?? 'Blue Voyage'); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Kart Başlığı (EN)</label>
                                        <input type="text" class="form-control" name="trend_yat_title_en" value="<?php echo e($settings['trend_yat_title_en'] ?? 'Blue Voyage'); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Alt Açıklama (TR)</label>
                                    <input type="text" class="form-control" name="trend_yat_desc_tr" value="<?php echo e($settings['trend_yat_desc_tr'] ?? 'Sonsuz mavilikte rotalar. Rüzgarın sesinden başka hiçbir şey yok.'); ?>">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Alt Açıklama (EN)</label>
                                    <input type="text" class="form-control" name="trend_yat_desc_en" value="<?php echo e($settings['trend_yat_desc_en'] ?? 'Routes in infinite blue. Nothing but the sound of the wind.'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Görsel</label>
                                <div class="img-preview-container" style="height: calc(100% - 25px); margin-top: 0;">
                                    <img class="img-preview" src="<?php echo e(asset($settings['trend_yat_img'] ?? 'foto.img/about_yacht.jpg')); ?>" alt="Trend Yat">
                        ...
                        <div style="display: grid; grid-template-columns: 1.3fr 1fr; gap: 1.5rem;">
                            <div>
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                    <div class="form-group">
                                        <label class="form-label">Kart Başlığı (TR)</label>
                                        <input type="text" class="form-control" name="trend_beach_title_tr" value="<?php echo e($settings['trend_beach_title_tr'] ?? 'Rups Beach'); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Kart Başlığı (EN)</label>
                                        <input type="text" class="form-control" name="trend_beach_title_en" value="<?php echo e($settings['trend_beach_title_en'] ?? 'Rups Beach'); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Alt Açıklama (TR)</label>
                                    <input type="text" class="form-control" name="trend_beach_desc_tr" value="<?php echo e($settings['trend_beach_desc_tr'] ?? 'Altın kumlar ve kristal sular. Müziğin ritmine eşlik eden anlar.'); ?>">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Alt Açıklama (EN)</label>
                                    <input type="text" class="form-control" name="trend_beach_desc_en" value="<?php echo e($settings['trend_beach_desc_en'] ?? 'Golden sands and crystal waters. Moments accompanying the rhythm of the music.'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Görsel</label>
                                <div class="img-preview-container" style="height: calc(100% - 25px); margin-top: 0;">
                                    <img class="img-preview" src="<?php echo e(asset($settings['trend_beach_img'] ?? 'foto.img/bodrum.jpg')); ?>" alt="Trend Beach">
            ...
            <div id="tab-about" class="setting-tab-pane">
                    ...
                    <div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="about_hero_eyebrow_tr" value="<?php echo e($settings['about_hero_eyebrow_tr'] ?? 'Biz Kimiz'); ?>">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Üst Başlık / Eyebrow (EN)</label>
                                <input type="text" class="form-control" name="about_hero_eyebrow_en" value="<?php echo e($settings['about_hero_eyebrow_en'] ?? 'Who We Are'); ?>">
                            </div>
                        </div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                <label class="form-label">Ana Başlık (TR)</label>
                                <input type="text" class="form-control" name="about_hero_title_tr" value="<?php echo e($settings['about_hero_title_tr'] ?? 'Dioreal Dijital'); ?>">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Ana Başlık (EN)</label>
                                <input type="text" class="form-control" name="about_hero_title_en" value="<?php echo e($settings['about_hero_title_en'] ?? 'Dioreal Digital'); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="img-preview-container" style="height: calc(100% - 25px); margin-top: 0;">
                            <img class="img-preview" src="<?php echo e(asset($settings['about_hero_img'] ?? 'foto.img/hero_4k.jpg')); ?>" alt="About Hero">
                    ...
                    <div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="about_story_eyebrow_tr" value="<?php echo e($settings['about_story_eyebrow_tr'] ?? 'Hikayemiz'); ?>">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Üst Başlık (EN)</label>
                                <input type="text" class="form-control" name="about_story_eyebrow_en" value="<?php echo e($settings['about_story_eyebrow_en'] ?? 'Our Story'); ?>">
                            </div>
                        </div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                <label class="form-label">Hikaye Başlığı (TR)</label>
                                <input type="text" class="form-control" name="about_story_title_tr" value="<?php echo e($settings['about_story_title_tr'] ?? '15 yıldır lüks seyahatin sesi'); ?>">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Hikaye Başlığı (EN)</label>
                                <input type="text" class="form-control" name="about_story_title_en" value="<?php echo e($settings['about_story_title_en'] ?? 'Voice of luxury travel for 15 years'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Paragraf 1 (TR)</label>
                            <textarea class="form-control" name="about_story_p1_tr" rows="2"><?php echo e($settings['about_story_p1_tr'] ?? '2010 yılında İstanbul\'da kurulan Dioreal Dijital, Türkiye\'nin öncü lüks seyahat ve yaşam tarzı medya platformuna dönüşmüştür.'); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Paragraf 1 (EN)</label>
                            <textarea class="form-control" name="about_story_p1_en" rows="2"><?php echo e($settings['about_story_p1_en'] ?? 'Founded in Istanbul in 2010, Dioreal Digital has evolved into Turkey\'s leading luxury travel and lifestyle media platform.'); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Paragraf 2 (TR)</label>
                            <textarea class="form-control" name="about_story_p2_tr" rows="2"><?php echo e($settings['about_story_p2_tr'] ?? 'Her destinasyonda bizzat bulunarak, her oteli bizatihi deneyimleyerek ve her markayı özenle seçerek güvenilir bir referans noktası haline geldik.'); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Paragraf 2 (EN)</label>
                            <textarea class="form-control" name="about_story_p2_en" rows="2"><?php echo e($settings['about_story_p2_en'] ?? 'By personally visiting every destination and experiencing every hotel firsthand, we\'ve become a trusted reference.'); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Hikayemiz Bölüm Görseli</label>
                        <div class="img-preview-container" style="height: calc(100% - 25px); margin-top: 0;">
                            <img class="img-preview" src="<?php echo e(asset($settings['about_story_img'] ?? 'foto.img/about_yacht.jpg')); ?>" alt="Story Image">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="about_stats_title_tr" value="<?php echo e($settings['about_stats_title_tr'] ?? '15 Yılın Mirası'); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Bölüm Başlığı (EN)</label>
                        <input type="text" class="form-control" name="about_stats_title_en" value="<?php echo e($settings['about_stats_title_en'] ?? 'Legacy of 15 Years'); ?>">
                    </div>
                </div>
                <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 1rem; margin-bottom: 2rem;">
                    ...
                    <div style="background: rgba(255, 255, 255, 0.01); border: 1px solid var(--border-color); padding: 1rem; border-radius: var(--radius-md);">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="about_stat1_num" value="<?php echo e($settings['about_stat1_num'] ?? '150+'); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Etiket (TR)</label>
                            <input type="text" class="form-control" name="about_stat1_label_tr" value="<?php echo e($settings['about_stat1_label_tr'] ?? 'Destinasyon'); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Etiket (EN)</label>
                            <input type="text" class="form-control" name="about_stat1_label_en" value="<?php echo e($settings['about_stat1_label_en'] ?? 'Destinations'); ?>">
                        </div>
                    </div>
                    <!-- Stat 2 -->
                    <div style="background: rgba(255, 255, 255, 0.01); border: 1px solid var(--border-color); padding: 1rem; border-radius: var(--radius-md);">
                        ...
                        <div class="form-group">
                            <label class="form-label">Değer (Sayı)</label>
                            <input type="text" class="form-control" name="about_stat2_num" value="<?php echo e($settings['about_stat2_num'] ?? '2M+'); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Etiket (TR)</label>
                            <input type="text" class="form-control" name="about_stat2_label_tr" value="<?php echo e($settings['about_stat2_label_tr'] ?? 'Aylık Okuyucu'); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Etiket (EN)</label>
                            <input type="text" class="form-control" name="about_stat2_label_en" value="<?php echo e($settings['about_stat2_label_en'] ?? 'Monthly Readers'); ?>">
                        </div>
                    </div>
                    <!-- Stat 3 -->
                    <div style="background: rgba(255, 255, 255, 0.01); border: 1px solid var(--border-color); padding: 1rem; border-radius: var(--radius-md);">
                        ...
                        <div class="form-group">
                            <label class="form-label">Değer (Sayı)</label>
                            <input type="text" class="form-control" name="about_stat3_num" value="<?php echo e($settings['about_stat3_num'] ?? '300+'); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Etiket (TR)</label>
                            <input type="text" class="form-control" name="about_stat3_label_tr" value="<?php echo e($settings['about_stat3_label_tr'] ?? 'Marka Ortağı'); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Etiket (EN)</label>
                            <input type="text" class="form-control" name="about_stat3_label_en" value="<?php echo e($settings['about_stat3_label_en'] ?? 'Brand Partners'); ?>">
                        </div>
                    </div>
                    <!-- Stat 4 -->
                    <div style="background: rgba(255, 255, 255, 0.01); border: 1px solid var(--border-color); padding: 1rem; border-radius: var(--radius-md);">
                        ...
                        <div class="form-group">
                            <label class="form-label">Değer (Sayı)</label>
                            <input type="text" class="form-control" name="about_stat4_num" value="<?php echo e($settings['about_stat4_num'] ?? '15'); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Etiket (TR)</label>
                            <input type="text" class="form-control" name="about_stat4_label_tr" value="<?php echo e($settings['about_stat4_label_tr'] ?? 'Yıllık Deneyim'); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Etiket (EN)</label>
                            <input type="text" class="form-control" name="about_stat4_label_en" value="<?php echo e($settings['about_stat4_label_en'] ?? 'Years of Experience'); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1.3fr 1fr; gap: 1.5rem;">
                    <div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                <label class="form-label">Üst Başlık (TR)</label>
                                <input type="text" class="form-control" name="about_mission_eyebrow_tr" value="<?php echo e($settings['about_mission_eyebrow_tr'] ?? 'Misyonumuz'); ?>">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Üst Başlık (EN)</label>
                                <input type="text" class="form-control" name="about_mission_eyebrow_en" value="<?php echo e($settings['about_mission_eyebrow_en'] ?? 'Our Mission'); ?>">
                            </div>
                        </div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                <label class="form-label">Misyon Başlığı (TR)</label>
                                <input type="text" class="form-control" name="about_mission_title_tr" value="<?php echo e($settings['about_mission_title_tr'] ?? 'Anlamlı deneyimler için'); ?>">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Misyon Başlığı (EN)</label>
                                <input type="text" class="form-control" name="about_mission_title_en" value="<?php echo e($settings['about_mission_title_en'] ?? 'For meaningful experiences'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Paragraf 1 (TR)</label>
                            <textarea class="form-control" name="about_mission_p1_tr" rows="2"><?php echo e($settings['about_mission_p1_tr'] ?? 'Sadece güzel yerler göstermiyoruz. Seyahatin ruhunu, bir destinasyonun gerçek özünü, yerel kültürün derinliğini aktarıyoruz.'); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Paragraf 1 (EN)</label>
                            <textarea class="form-control" name="about_mission_p1_en" rows="2"><?php echo e($settings['about_mission_p1_en'] ?? 'We don\'t just show beautiful places. We convey the true essence of a destination.'); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Paragraf 2 (TR)</label>
                            <textarea class="form-control" name="about_mission_p2_tr" rows="2"><?php echo e($settings['about_mission_p2_tr'] ?? 'Okuyucularımız bize güvenir, markalarımız bize inanır, destinasyonlar bizi ortaklık arar çünkü söylediğimiz her şey gerçek.'); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Paragraf 2 (EN)</label>
                            <textarea class="form-control" name="about_mission_p2_en" rows="2"><?php echo e($settings['about_mission_p2_en'] ?? 'Our readers trust us, our brands believe in us, and destinations seek partnerships because everything we say is authentic.'); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Misyon Bölüm Görseli</label>
                        <div class="img-preview-container" style="height: calc(100% - 25px); margin-top: 0;">
                            <img class="img-preview" src="<?php echo e(asset($settings['about_mission_img'] ?? 'foto.img/about_safari.jpg')); ?>" alt="Mission Image">
    ...
    <div class="panel-card">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem; padding: 1.5rem;">
            ...
            <div>
                ...
                <?php if(isset($settings['brands']) && is_array($settings['brands']) && count($settings['brands']) > 0): ?>
                    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(130px, 1fr)); gap: 1rem; max-height: 400px; overflow-y: auto; padding-right: 0.5rem;">
                        <?php $__currentLoopData = $settings['brands']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="background: rgba(15, 23, 42, 0.4); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 0.75rem; display: flex; flex-direction: column; align-items: center; justify-content: space-between; text-align: center; height: 120px; position: relative;">
                                <div style="width: 100%; height: 50px; display: flex; align-items: center; justify-content: center; background: rgba(0, 0, 0, 0.1); border-radius: 4px; overflow: hidden; margin-bottom: 0.5rem;">
                                    <img src="<?php echo e(asset($brand['img'])); ?>" alt="<?php echo e($brand['name']); ?>" style="max-width: 90%; max-height: 90%; object-fit: contain; filter: brightness(0) invert(1);">
                                </div>
                                <span style="font-size: 0.8rem; font-weight: 500; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 100%;"><?php echo e($brand['name']); ?></span>
                                
                                <button type="button" 
                                        class="edit-brand-btn"
                                        data-index="<?php echo e($index); ?>" 
                                        data-name="<?php echo e($brand['name']); ?>" 
                                        data-img="<?php echo e(asset($brand['img'])); ?>" 
                                        data-url="<?php echo e(route('admin.settings.update_brand', $index)); ?>"
                                ...
                                <form action="<?php echo e(route('admin.settings.delete_brand', $index)); ?>" method="POST" onsubmit="return confirm('Bu markayı referanslardan kaldırmak istediğinizden emin misiniz?');" style="position: absolute; top: 5px; right: 5px;">
                                    <?php echo csrf_field(); ?>
            ...
            <div style="background: rgba(255, 255, 255, 0.02); border: 1px solid var(--border-color); border-radius: var(--radius-lg); padding: 1.5rem;">
                ...
                <form action="<?php echo e(route('admin.settings.add_brand')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmet\Desktop\dioreal web\resources\views\admin\settings.blade.php ENDPATH**/ ?>