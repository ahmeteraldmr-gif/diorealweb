...
<body>
    ...
    <nav id="mainNav">
        ...
        <ul class="nav-links">
            ...
            <li><a href="<?php echo e(url('/yatlar')); ?>" class="active-page" data-i18n="nav_yachts">Yatlar</a></li>
    ...
    ?>
    <div class="page-hero" style="<?php if(!$showVideoCover): ?> background-image: url('<?php echo e($yatImgUrl); ?>'); <?php endif; ?>">
        <?php if($showVideoCover): ?>
            <div class="hero-video-container" style="position: absolute; inset: 0; width: 100%; height: 100%; overflow: hidden; z-index: 0;">
                <?php if(!empty($yat->video_file)): ?>
                    <video src="<?php echo e(asset($yat->video_file)); ?>" autoplay loop muted playsinline style="width: 100%; height: 100%; object-fit: cover;"></video>
                <?php elseif(!empty($yat->video_url)): ?>
                    <?php
        ...
        <div class="page-hero-content" style="position: relative; z-index: 2;">
            <span class="page-eyebrow lang-text-tr"><?php echo e($yat->tag['tr'] ?? 'Lüks Yat Kiralama'); ?></span>
            <span class="page-eyebrow lang-text-en"><?php echo e($yat->tag['en'] ?? 'Luxury Yacht Charter'); ?></span>
            <h1 class="page-title lang-text-tr"><?php echo e($yat->name['tr'] ?? ''); ?></h1>
            <h1 class="page-title lang-text-en"><?php echo e($yat->name['en'] ?? ''); ?></h1>
        </div>
    </div>
        ...
        <div class="detail-grid">
            ...
            <div class="detail-story reveal">
                ...
                <div class="lang-text-tr">
                    <?php echo nl2br($yat->long_desc['tr'] ?? ($yat->desc['tr'] ?? '')); ?>

                </div>
                <div class="lang-text-en">
                    <?php echo nl2br($yat->long_desc['en'] ?? ($yat->desc['en'] ?? '')); ?>
            ...
            <div class="detail-sidebar-card reveal" style="transition-delay: 0.2s">
                ...
                <div class="sidebar-info-item">
                    ...
                    <div>
                        ...
                        <div class="sidebar-info-value lang-text-tr"><?php echo e($yat->tag['tr'] ?? 'Lüks Gulet & Yat'); ?></div>
                        <div class="sidebar-info-value lang-text-en"><?php echo e($yat->tag['en'] ?? 'Luxury Gulet & Yacht'); ?></div>
                    </div>
                </div>
                ...
                <a href="https://wa.me/<?php echo e(format_whatsapp($settings['whatsapp'] ?? '')); ?>?text=Merhaba,%20<?php echo e(urlencode($yat->name['tr'] ?? $yat->name['en'] ?? 'Yat')); ?>%20hakkında%20detaylı%20bilgi%20ve%20kiralama%20koşullarını%20öğrenmek%20istiyorum." 
                   target="_blank" 
                   class="btn-booking">
    ...
    <?php if(!empty($yat->video_file) || !empty($yat->video_url)): ?>
        <section class="video-section reveal" style="max-width: 1200px; margin: 0 auto 5rem auto; padding: 0 2rem;">
            ...
            <div class="video-container" style="position: relative; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 50px rgba(0,0,0,0.15); background: #000; aspect-ratio: 16/9; max-width: 900px; margin: 0 auto;">
                <?php if(!empty($yat->video_file)): ?>
                    <video src="<?php echo e(asset($yat->video_file)); ?>" controls style="width: 100%; height: 100%; object-fit: cover;"></video>
                <?php elseif(!empty($yat->video_url)): ?>
                    <?php
                        $embedUrl = $yat->video_url;
                        if (preg_match('/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/ ]{11})/', $yat->video_url, $matches)) {
    ...
    <section class="gallery-section reveal">
        ...
        <div class="gallery-grid">
            <?php if(!empty($yat->gallery) && is_array($yat->gallery)): ?>
                <?php $__currentLoopData = $yat->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="gallery-img-wrapper">
                        <img src="<?php echo e(str_starts_with($g, 'data:') ? $g : asset($g)); ?>" alt="Yat Görseli">
                    </div>
...
<?php /**PATH C:\Users\ahmet\Desktop\dioreal web\resources\views\yat-detay.blade.php ENDPATH**/ ?>