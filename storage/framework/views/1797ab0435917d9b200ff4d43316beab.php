...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/nav-footer.css')); ?>">
...
<body>
    ...
    <div class="error-container">
        ...
        <div class="error-btns">
            <a href="<?php echo e(route('home')); ?>" class="btn-gold">
                <span class="lang-text-tr">Ana Sayfaya Dön</span>
                <span class="lang-text-en">Back to Home</span>
            </a>
            <a href="<?php echo e(route('journal')); ?>" class="btn btn-outline" style="border-color: var(--white); color: var(--white);">
...
<?php /**PATH C:\Users\ahmet\Desktop\dioreal web\resources\views\errors\404.blade.php ENDPATH**/ ?>