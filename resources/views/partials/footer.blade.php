<footer id="iletisim">
    <div class="footer-top">
        <div class="footer-brand">
            ...
            <p class="footer-p" data-i18n="footer_p">
                <span class="lang-text-tr">Seçkin destinasyonları ve markaları doğru kitleyle buluşturan medya platformu.</span>
                <span class="lang-text-en">Media platform connecting exclusive destinations and brands with the right audience.</span>
            </p>
        ...
        <div class="footer-col">
            ...
            <ul class="footer-links">
                <li><a href="{{ route('oteller') }}"><span class="lang-text-tr">Balayı Paketleri</span><span class="lang-text-en">Honeymoon Experiences</span></a></li>
                <li><a href="{{ route('gezi-rehberi') }}"><span class="lang-text-tr">Aile Tatilleri</span><span class="lang-text-en">Family Travel</span></a></li>
                <li><a href="{{ route('etkinlikler') }}"><span class="lang-text-tr">Macera Turları</span><span class="lang-text-en">Adventure Travel</span></a></li>
                <li><a href="{{ route('gezi-rehberi') }}"><span class="lang-text-tr">Kültür Gezileri</span><span class="lang-text-en">Cultural Journeys</span></a></li>
                <li><a href="{{ route('yatlar') }}"><span class="lang-text-tr">Özel Yat Hizmetleri</span><span class="lang-text-en">Private Yacht Experiences</span></a></li>
            </ul>
        </div>
        <div class="footer-col">
