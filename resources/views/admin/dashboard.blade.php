        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="card">
                <div class="flex items-center">
                    <div class="flex-shrink-0 rounded-lg p-3" style="background-color: rgba(37, 99, 235, 0.15);">
                        <svg class="h-6 w-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="stroke-width: 2.5px;">
            ...
            <div class="card">
                <div class="flex items-center">
                    <div class="flex-shrink-0 rounded-lg p-3" style="background-color: rgba(16, 185, 129, 0.15);">
                        <svg class="h-6 w-6 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="stroke-width: 2.5px;">
            ...
            <div class="card">
                <div class="flex items-center">
                    <div class="flex-shrink-0 rounded-lg p-3" style="background-color: rgba(34, 197, 94, 0.15);">
                        <svg class="h-6 w-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="stroke-width: 2.5px;">
            ...
            <div class="card">
                <div class="flex items-center">
                    <div class="flex-shrink-0 rounded-lg p-3" style="background-color: rgba(168, 85, 247, 0.15);">
                        <svg class="h-6 w-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="stroke-width: 2.5px;">
