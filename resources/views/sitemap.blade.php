...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    ...
    <url>
        <loc>{{ route('otel.detay', $hotel->id) }}</loc>
    ...
    <url>
        <loc>{{ route('restoran.detay', $restaurant->id) }}</loc>
    ...
    <url>
        <loc>{{ route('yat.detay', $yacht->id) }}</loc>
    ...
    <url>
        <loc>{{ route('destinasyon.detay', $destination->id) }}</loc>
    ...
    <url>
        <loc>{{ route('rehber.detay', $guide->id) }}</loc>
    ...
    <url>
        <loc>{{ route('etkinlik.detay', $event->id) }}</loc>
    ...
    <url>
        <loc>{{ route('journal.detay', $journal->id) }}</loc>
