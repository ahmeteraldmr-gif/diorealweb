...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/home.css') }}?v=2.5.0">
    @php
...
<body>
    ...
    <div class="marquee" style="position:relative;z-index:2;">
        <div class="marquee-track" style="pointer-events:auto;">
            <!-- SET A -->
            <div class="marquee-item"><a href="{{ url('/destinasyon/istanbul') }}" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_istanbul" style="color: inherit !important;">İstanbul</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="{{ url('/destinasyon/bodrum') }}" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_bodrum" style="color: inherit !important;">Bodrum</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="{{ url('/destinasyon/fethiye') }}" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_fethiye" style="color: inherit !important;">Fethiye</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="{{ url('/destinasyon/kapadokya') }}" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_kapadokya" style="color: inherit !important;">Kapadokya</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="{{ url('/destinasyon/cesme') }}" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_cesme" style="color: inherit !important;">Çeşme</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="{{ url('/destinasyon/kas') }}" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_kas" style="color: inherit !important;">Kaş</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item"><a href="{{ url('/destinasyon/datca') }}" class="marquee-link" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_datca" style="color: inherit !important;">Datça</span></a> <span class="marquee-dot">◆</span></div>
            <!-- SET B (Clone) -->
            <div class="marquee-item" aria-hidden="true"><a href="{{ url('/destinasyon/istanbul') }}" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_istanbul" style="color: inherit !important;">İstanbul</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="{{ url('/destinasyon/bodrum') }}" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_bodrum" style="color: inherit !important;">Bodrum</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="{{ url('/destinasyon/fethiye') }}" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_fethiye" style="color: inherit !important;">Fethiye</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="{{ url('/destinasyon/kapadokya') }}" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_kapadokya" style="color: inherit !important;">Kapadokya</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="{{ url('/destinasyon/cesme') }}" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_cesme" style="color: inherit !important;">Çeşme</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="{{ url('/destinasyon/kas') }}" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_kas" style="color: inherit !important;">Kaş</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="{{ url('/destinasyon/datca') }}" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_datca" style="color: inherit !important;">Datça</span></a> <span class="marquee-dot">◆</span></div>
            <!-- SET C (Clone) -->
            <div class="marquee-item" aria-hidden="true"><a href="{{ url('/destinasyon/istanbul') }}" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_istanbul" style="color: inherit !important;">İstanbul</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="{{ url('/destinasyon/bodrum') }}" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_bodrum" style="color: inherit !important;">Bodrum</span></a> <span class="marquee-dot">◆</span></div>
            <div class="marquee-item" aria-hidden="true"><a href="{{ url('/destinasyon/fethiye') }}" class="marquee-link" tabindex="-1" aria-hidden="true" style="color: rgba(255, 255, 255, 0.22) !important; text-decoration: none !important;"><span data-i18n="dest_fethiye" style="color: inherit !important;">Fethiye</span></a> <span class="marquee-dot">◆</span></div>
            ...
            <div class="marquee-container">
                <div class="marquee-track">
                    ...
                    <div class="marquee-content" aria-hidden="true">
                        @foreach($destinations['turkiye'] as $dest)
                            <a href="{{ route('destinasyon.detay', $dest->slug_tr ?: ($dest->slug_en ?: $dest->id)) }}" class="dest-card-h" tabindex="-1" aria-hidden="true" style="display: block; text-decoration: none; color: inherit;">
                                <div class="dest-img-container">
                                    <div class="dest-img" style="background-image:url('{{ asset(!empty($dest->img) ? $dest->img : 'foto.img/amalfi.webp') }}'); position: absolute; inset: 0; background-size: cover; background-position: center; transition: transform 0.9s cubic-bezier(0.25, 0.46, 0.45, 0.94);"></div>
                                </div>
                                <div class="dest-info-ext">
    ...
    <script src="{{ asset('js/home.js') }}?v=2.5.0"></script>
</body>
