...
<body>
    <nav id="mainNav">
        ...
        <ul class="nav-links">
            <li><a href="{{ route('hakkimizda') }}" class="active-page" data-i18n="nav_about">Hakkımızda</a></li>
        ...
        <div class="content-grid">
            <div class="reveal">
                ...
                <h2 class="content-title">
                    <span class="lang-text-tr">{!! $settings['about_story_title_tr'] ?? '15 yıldır <em>seyahatin</em> sesi' !!}</span>
                    <span class="lang-text-en">{!! $settings['about_story_title_en'] ?? 'Voice of <em>travel</em> for 15 years' !!}</span>
                </h2>
                <div class="lang-text-tr">
                    <p class="content-body">{!! nl2br(e($settings['about_story_p1_tr'] ?? '2010 yılında İstanbul\'da kurulan Dioreal Dijital, Türkiye\'nin öncü seyahat ve yaşam tarzı medya platformuna dönüşmüştür. Seçkin destinasyonlar, seçkin markalar ve doğru kitleyi bir araya getiren köprü olmak misyonuyla kurulduk.')) !!}</p>
                ...
                <div class="lang-text-en">
                    <p class="content-body">{!! nl2br(e($settings['about_story_p1_en'] ?? 'Founded in Istanbul in 2010, Dioreal Digital has evolved into Turkey\'s leading travel and lifestyle media platform.')) !!}</p>
